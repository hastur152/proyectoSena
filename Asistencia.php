...
<!-- 
    <form action="">
        ...
        <input type="text" name="Nombre" placeholder="Ingresa el dia">
        <input type="text" name="Nombre" placeholder="Ingresa el fecha">
        <input type="text" name="Nombre" placeholder="Ingresa el mes">
