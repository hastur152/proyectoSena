...
<?php if(!empty($user)): ?>
    ...
    <form action="">
        ...
        <h2>CONTACTAR DOCENTE</h2>
        <input type="text" name="curso" placeholder="Ingresa el curso">
        <input type="text" name="Nombre" placeholder="Ingresa asignatura">
        <input type="text" name="Nombre" placeholder="Ingresa el Nombre del profesot">

        <textarea name="mensaje" placeholder="¿mostrara la info aca?" ></textarea>
