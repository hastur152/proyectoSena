...
<?php if(!empty($user)): ?>
    ...
    <form action="">
        ...
        <input type="text" name="Nombre" placeholder="Ingresa nota primer corte">
        <input type="text" name="Nombre" placeholder="Ingresa nota segundo corte">
        <input type="text" name="Nombre" placeholder="Ingresa nota tercer corte">
